...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function loadRetailerList() {
        ...
        const apiUrl = `http://localhost:8080/api/admin/retailer/list-by-creator?creatorEmail=${encodeURIComponent(userEmail)}`;
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch(`http://localhost:8080/api/admin/retailer/list-by-creator?creatorEmail=${sessionUserEmail}`)
        .then(response => response.json())
        .then(data => {
        const retailers = data.retailers;
        ...
        retailers.forEach(retailer => {
            ...
            fetch(`http://localhost:8080/api/admin/retailer/recent-activities?userEmail=${retailer.email}`)
                .then(response => response.json())
                .then(activities => {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function fetchActivities() {
        try {
            ...
            const response = await fetch(`http://localhost:8080/api/admin/distributor/distributor?distributorEmail=${userEmail}`);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function loadTokenDistribution() {
        ...
        const apiUrl = `http://localhost:8080/api/admin/token/transactions?email=${encodeURIComponent(userEmail)}`;
