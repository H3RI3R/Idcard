...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchIdCardById(id) {
        fetch(`http://localhost:8080/api/admin/retailer/idcard?id=${encodeURIComponent(id)}`)
            .then(response => response.json())
            .then(data => {
            if (data.error) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (retailerEmail) {
        fetch(`http://localhost:8080/api/admin/retailer/idcard-history?retailerEmail=${encodeURIComponent(retailerEmail)}`)
            .then(response => response.json())
            .then(data => {
