...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiUrl = `http://localhost:8080/api/admin/distributor/userInfo?email=${encodeURIComponent(userEmail)}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const apiUrl = `http://localhost:8080/api/admin/distributor/name?email=${encodeURIComponent(userEmail)}`;
