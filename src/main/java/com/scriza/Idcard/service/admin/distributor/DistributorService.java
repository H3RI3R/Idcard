...
public class DistributorService {
    ...
    public User createDistributor(String name ,String email, String password, String phoneNumber,String creatorEmail,String designation ,String company , String address) {
        ...
        distributor.setDesignation(designation);
    ...
    public void deleteDistributor(String email) {
        User user = userRepository.findByEmail(email);
        if (user != null) {
            ...
            logActivity("DISTRIBUTOR_DELETION", "Deleted distributor: " + email, user.getCreatorEmail());
        } else {
